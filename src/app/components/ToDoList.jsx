  ...
  return (
    <div className="p-4 max-w-screen-xl mx-auto">
      <div className="relative">
        <h1 className="bg-yellow-400 text-2xl font-bold text-center py-3 rounded-md shadow-md">
          To Do List
        </h1>
      </div>
          ...
          <tbody>
            {currentItems.map((item, index) => (
              ...
              >
                ...
                <td className="border border-gray-300 p-2">{item.angsuran}</td>
                <td className="border border-gray-300 p-2">
